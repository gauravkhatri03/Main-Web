  ...
  render() {
    ...
    return (
      ...
      <div className="wrapper flx">
        ...
        <Carousel enableKeyboardControls={true} withoutControls={false} style={{height:'750px',color:'white'}}>
        <div className="one">
        <h3 className="title">Slide 1</h3>
          <div className="row mrf">
            <div className="col-md-4 col-sm-12">
              <img src={require('../../assets/img/ryan.jpg')}  className=" rounded-circle img-set img-center"/>
